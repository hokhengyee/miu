...
export class StudentProfileComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.studentProfileService
            ...
            .subscribe(
                (res: HttpResponse<IStudentProfile[]>) => this.paginateStudentProfiles(res.body, res.headers),
    ...
    private paginateStudentProfiles(data: IStudentProfile[], headers: HttpHeaders) {
