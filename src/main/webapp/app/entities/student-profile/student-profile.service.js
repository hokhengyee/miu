(function() {
	'use strict';
	angular.module('miuApp').factory('StudentProfile', StudentProfile);
				...
				{},
				{
					...
					'update' : {
						...
						transformRequest : function(data) {
							...
							copy.applicationDate = DateUtils
									.convertLocalDateToServer(copy.applicationDate);
							copy.commencementDate = DateUtils
									.convertLocalDateToServer(copy.commencementDate);
							copy.completionDate = DateUtils
									.convertLocalDateToServer(copy.completionDate);
