(function() {
    ...
    ModuleDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Module', 'Course'];

    function ModuleDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Module, Course) {
        var vm = this;
