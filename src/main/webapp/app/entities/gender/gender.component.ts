...
export class GenderComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.genderService
            ...
            .subscribe(
                (res: HttpResponse<IGender[]>) => this.paginateGenders(res.body, res.headers),
    ...
    trackId(index: number, item: IGender) {
        return item.id;
    }
    ...
    private paginateGenders(data: IGender[], headers: HttpHeaders) {
