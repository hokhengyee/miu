...
export class NewsAndEventComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.newsAndEventService
            ...
            .subscribe(
                (res: HttpResponse<INewsAndEvent[]>) => this.paginateNewsAndEvents(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/news-and-event'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: INewsAndEvent) {
        return item.id;
    }
    ...
    registerChangeInNewsAndEvents() {
        this.eventSubscriber = this.eventManager.subscribe('newsAndEventListModification', response => this.loadAll());
    }
    ...
    private paginateNewsAndEvents(data: INewsAndEvent[], headers: HttpHeaders) {
