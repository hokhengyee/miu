(function() {
	...
	EntryQualificationController.$inject = [ '$scope', '$state',
			'EntryQualification', 'ParseLinks', 'AlertService',
			'paginationConstants', 'pagingParams' ];

	function EntryQualificationController($scope, $state, EntryQualification,
			ParseLinks, AlertService, paginationConstants, pagingParams, $sce) {
		var vm = this;
