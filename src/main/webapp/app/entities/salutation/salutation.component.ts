...
export class SalutationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.salutationService
            ...
            .subscribe(
                (res: HttpResponse<ISalutation[]>) => this.paginateSalutations(res.body, res.headers),
    ...
    trackId(index: number, item: ISalutation) {
        return item.id;
    }
    ...
    private paginateSalutations(data: ISalutation[], headers: HttpHeaders) {
