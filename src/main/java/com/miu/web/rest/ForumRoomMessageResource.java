...
public class ForumRoomMessageResource {
	...
	private final Logger LOGGER = LoggerFactory.getLogger(ForumRoomMessageResource.class);
	...
	@Timed
	public ResponseEntity<ForumRoomMessage> createForumRoomMessage(
			@Valid @RequestBody ForumRoomMessage forumRoomMessage) throws URISyntaxException {
		LOGGER.debug("REST request to save ForumRoomMessage : {}", forumRoomMessage);
	 ...
	 *
	 * @param id
	 *            the id of the forumRoomMessage to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         forumRoomMessage, or with status 404 (Not Found)
	 */
	 ...
	 *
	 * @param forumRoomMessage
	 *            the forumRoomMessage to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         forumRoomMessage, or with status 400 (Bad Request) if the
	 *         forumRoomMessage is not valid, or with status 500 (Internal
	 *         Server Error) if the forumRoomMessage couldnt be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/forum-room-messages")
	@Timed
	public ResponseEntity<ForumRoomMessage> updateForumRoomMessage(
			@Valid @RequestBody ForumRoomMessage forumRoomMessage) throws URISyntaxException {
		LOGGER.debug("REST request to update ForumRoomMessage : {}", forumRoomMessage);
