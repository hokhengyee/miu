...
public class CourseMaterialAccessResource {
	 ...
	 *
	 * @param courseMaterialAccess
	 *            the courseMaterialAccess to create
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new courseMaterialAccess, or with status 400 (Bad Request) if the
	 *         courseMaterialAccess has already an ID
	 ...
	 *
	 * @param courseMaterialAccess
	 *            the courseMaterialAccess to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         courseMaterialAccess, or with status 400 (Bad Request) if the
	 *         courseMaterialAccess is not valid, or with status 500 (Internal
	 *         Server Error) if the courseMaterialAccess couldnt be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	...
	public ResponseEntity<CourseMaterialAccess> updateCourseMaterialAccess(
		...
		return ResponseEntity.ok().headers(
				HeaderUtil.createEntityUpdateAlert("courseMaterialAccess", courseMaterialAccess.getId().toString()))
				.body(result);
	}
	 ...
	 *         courseMaterialAccesses in body
	 * @throws URISyntaxException
	 ...
	 *
	 * @param id
	 *            the id of the courseMaterialAccess to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         courseMaterialAccess, or with status 404 (Not Found)
	 */
	...
	/**
	 * DELETE /course-material-accesses/:id : delete the "id"
	 * courseMaterialAccess.
	 *
	 * @param id
	 *            the id of the courseMaterialAccess to delete
