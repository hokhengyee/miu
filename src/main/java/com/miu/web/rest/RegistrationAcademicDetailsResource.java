...
public class RegistrationAcademicDetailsResource {
     ...
     *
     * @param registrationAcademicDetails the registrationAcademicDetails to create
     * @return the ResponseEntity with status 201 (Created) and with body the new registrationAcademicDetails, or with status 400 (Bad Request) if the registrationAcademicDetails has already an ID
    ...
    /**
     * PUT  /registration-academic-details : Updates an existing registrationAcademicDetails.
     *
    ...
    /**
     * GET  /registration-academic-details : get all the registrationAcademicDetails.
     *
    ...
    /**
     * GET  /registration-academic-details/:id : get the "id" registrationAcademicDetails.
     *
     * @param id the id of the registrationAcademicDetails to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the registrationAcademicDetails, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /registration-academic-details/:id : delete the "id" registrationAcademicDetails.
     *
     * @param id the id of the registrationAcademicDetails to delete
