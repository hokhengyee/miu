...
public class OnlineApplication implements Serializable {
	...
	public String toString() {
		return "OnlineApplication{" + "id=" + id + ", nricNo='" + nricNo + "'" + ", dateOfBirth='" + dateOfBirth + "'"
				+ ", telephone='" + telephone + "'" + ", email='" + email + "'" + ", city='" + city + "'" + ", state='"
				+ state + "'" + ", country='" + country + "'" + ", postcode='" + postcode + "'"
				+ ", registrationDatetime='" + registrationDatetime + "'" + ", surname='" + surname + "'"
				+ ", givenName='" + givenName + "'" + ", address='" + address + "'" + ", applicationForm='"
				+ applicationForm + "'" + ", applicationFormContentType='" + applicationFormContentType + "'" + '}';
	}
}
