...
public class RecordOfCertificateResourceIntTest {
    ...
    private static final byte[] UPDATED_CERT_SCAN_FILE = TestUtil.createByteArray(2, "1");
    ...
    public void setup() {
        ...
        RecordOfCertificateResource recordOfCertificateResource = new RecordOfCertificateResource();
        ReflectionTestUtils.setField(recordOfCertificateResource, "recordOfCertificateRepository", recordOfCertificateRepository);
    ...
    public void createRecordOfCertificateWithExistingId() throws Exception {
        ...
        RecordOfCertificate existingRecordOfCertificate = new RecordOfCertificate();
        existingRecordOfCertificate.setId(1L);

        // An entity with an existing ID cannot be created, so this API call must fail
        restRecordOfCertificateMockMvc.perform(post("/api/record-of-certificates")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingRecordOfCertificate)))
    ...
    public void updateRecordOfCertificate() throws Exception {
        ...
        RecordOfCertificate updatedRecordOfCertificate = recordOfCertificateRepository.findOne(recordOfCertificate.getId());
    ...
    public void updateNonExistingRecordOfCertificate() throws Exception {
        ...
        // Validate the RecordOfCertificate in the database
        List<RecordOfCertificate> recordOfCertificateList = recordOfCertificateRepository.findAll();
        assertThat(recordOfCertificateList).hasSize(databaseSizeBeforeUpdate + 1);
    }
