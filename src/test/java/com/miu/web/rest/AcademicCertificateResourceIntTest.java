...
public class AcademicCertificateResourceIntTest {
    ...
    private static final byte[] UPDATED_ACADEMIC_CERTIFICATE_1 = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_ACADEMIC_CERTIFICATE_2 = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_ACADEMIC_CERTIFICATE_3 = TestUtil.createByteArray(1, "1");
    ...
    public void setup() {
        ...
        final AcademicCertificateResource academicCertificateResource = new AcademicCertificateResource(academicCertificateRepository);
    ...
    public void updateAcademicCertificate() throws Exception {
        ...
        AcademicCertificate updatedAcademicCertificate = academicCertificateRepository.findById(academicCertificate.getId()).get();
        // Disconnect from session so that the updates on updatedAcademicCertificate are not directly saved in db
        em.detach(updatedAcademicCertificate);
    ...
    public void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(AcademicCertificate.class);
        AcademicCertificate academicCertificate1 = new AcademicCertificate();
        academicCertificate1.setId(1L);
        AcademicCertificate academicCertificate2 = new AcademicCertificate();
        academicCertificate2.setId(academicCertificate1.getId());
        assertThat(academicCertificate1).isEqualTo(academicCertificate2);
        academicCertificate2.setId(2L);
        assertThat(academicCertificate1).isNotEqualTo(academicCertificate2);
        academicCertificate1.setId(null);
        assertThat(academicCertificate1).isNotEqualTo(academicCertificate2);
    }
}
