...
class OnlineApplicationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the OnlineApplication entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "dateOfBirth":"2020-01-01T00:00:00.000Z", "telephone":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "state":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "postcode":"SAMPLE_TEXT", "registrationDatetime":"2020-01-01T00:00:00.000Z", "surname":"SAMPLE_TEXT", "givenName":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "applicationForm":null, "profilePhoto":null, "academicCertificate":null, "letterOfRecommendation":null, "profileDocument":null}""")).asJSON
            .check(status.is(201))
