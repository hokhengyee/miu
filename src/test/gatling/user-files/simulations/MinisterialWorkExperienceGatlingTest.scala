...
class MinisterialWorkExperienceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MinisterialWorkExperience entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                "id":null
                , "nameOfMinistry2":"SAMPLE_TEXT"
                , "areaOfMinistry2":"SAMPLE_TEXT"
                , "nameOfMinistry3":"SAMPLE_TEXT"
                , "areaOfMinistry3":"SAMPLE_TEXT"
                , "nameOfMinistry4":"SAMPLE_TEXT"
                , "areaOfMinistry4":"SAMPLE_TEXT"
                , "md5Key":"SAMPLE_TEXT"
                , "years2":null
                , "years3":null
                , "years4":null
                , "nameOfMinistry1":"SAMPLE_TEXT"
