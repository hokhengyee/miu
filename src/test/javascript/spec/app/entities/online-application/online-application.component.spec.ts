...
import { OnlineApplicationComponent } from 'app/entities/online-application/online-application.component';
...
describe('Component Tests', () => {
    describe('OnlineApplication Management Component', () => {
        let comp: OnlineApplicationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OnlineApplicationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new OnlineApplication(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.onlineApplications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
