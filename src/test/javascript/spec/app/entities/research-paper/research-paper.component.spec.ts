...
import { ResearchPaperComponent } from 'app/entities/research-paper/research-paper.component';
...
describe('Component Tests', () => {
    describe('ResearchPaper Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ResearchPaperComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.researchPapers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
