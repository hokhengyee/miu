...
import { StaticPageComponent } from 'app/entities/static-page/static-page.component';
...
describe('Component Tests', () => {
    describe('StaticPage Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StaticPageComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.staticPages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
