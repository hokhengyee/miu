...
import { CourseMaterialComponent } from 'app/entities/course-material/course-material.component';
...
describe('Component Tests', () => {
    describe('CourseMaterial Management Component', () => {
        let comp: CourseMaterialComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CourseMaterialComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.courseMaterials[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
