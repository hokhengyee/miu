...
import { SalutationComponent } from 'app/entities/salutation/salutation.component';
...
describe('Component Tests', () => {
    describe('Salutation Management Component', () => {
        let comp: SalutationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SalutationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.salutations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
