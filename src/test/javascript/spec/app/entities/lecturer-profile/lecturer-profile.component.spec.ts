...
import { LecturerProfileComponent } from 'app/entities/lecturer-profile/lecturer-profile.component';
...
describe('Component Tests', () => {
    describe('LecturerProfile Management Component', () => {
        let comp: LecturerProfileComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LecturerProfileComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.lecturerProfiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
