...
import { ModuleTypeComponent } from 'app/entities/module-type/module-type.component';
...
describe('Component Tests', () => {
    describe('ModuleType Management Component', () => {
        let comp: ModuleTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ModuleTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.moduleTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
