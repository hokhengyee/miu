...
import { StudentPaymentComponent } from 'app/entities/student-payment/student-payment.component';
...
describe('Component Tests', () => {
    describe('StudentPayment Management Component', () => {
        let comp: StudentPaymentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StudentPaymentComponent, '')
                .compileComponents();
